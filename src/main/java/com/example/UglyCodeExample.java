...
public class    UglyCodeExample {
    ...
    public   static  void  main   (  String[]   args ) throws IOException {
        ...
        System.out.print("Enter something: "); String line = br.readLine();
        if (line != null && line.length() > 0) { System.out.println("You entered: " + line); } else { System.out.println("You entered nothing."); }
    }
